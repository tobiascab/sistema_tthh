...
public class ReportesServiceImpl implements ReportesService {
    ...
    public DashboardAdminDTO getDashboardAdmin() {
        try {
            ...
            dashboard.setCapacitacionesUltimos6Meses(new ArrayList<>());
    ...
    @Override
    public Map<String, Object> getReporteCapacitacion(Integer anio) {
        Map<String, Object> reporte = new HashMap<>();
        reporte.put("anio", anio);
        reporte.put("totalHoras", 0);
        reporte.put("totalCapacitaciones", 0);
        reporte.put("participantes", 0);
        return reporte;
    }
