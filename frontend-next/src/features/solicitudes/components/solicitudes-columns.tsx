...
export const getSolicitudesColumns = ({
    ...
    isAdminOrManager,
}: SolicitudesColumnsProps): ColumnDef<Solicitud>[] => [
        {
            ...
            header: "Colaborador",
            cell: ({ row }) => {
                // Asumimos que el DTO podría traer info extra, o mostramos nombre genérico
                // Lo ideal sería mostrar Nº Socio aquí, pero si no viene en el DTO, mostramos Nombre.
                return (
        ...
        },
        {
            ...
            cell: ({ row }) => {
                // Usamos createdAt o fechaSolicitud dependiendo del DTO
